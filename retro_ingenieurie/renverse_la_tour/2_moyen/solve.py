def hash():
    ...
    n = ''
    p = ''
    f = [88, 1, 140, 1, 203, 208, 89, 207, 132, 191, 178, 110, 138, 132, 210, 1, 140, 156, 138, 140, 191, 187, 89, 89, 187, 1, 208, 231, 161, 235, 178, 188, 187, 132, 187] # len = 35
...
# check that all elements in d are unique
#    for i in range(len(d)):
#        print(d[i])

    flag_reversed = ''
    for j in range(len(f)):
        flag_reversed += chr(d.index(f[j]))

    flag = ''
    for k in range(len(flag_reversed)):
        flag += flag_reversed[int(len(flag_reversed) - k - 1)]
    print(flag)
